...
void buildScene() {
	...
	IDisk* disk1 = new IDisk(dvec3(15.0, 0.0, 0.0), dvec3(0.0, 0.0, 1.0), 5.0);
	IDisk* disk2 = new IDisk(dvec3(-10.0, 10.0, 2.0), dvec3(0.0, 0.0, 3.0), 2.0);
	...
	scene.addOpaqueObject(new VisibleIShape(disk1, cyanPlastic));
	scene.addOpaqueObject(new VisibleIShape(disk2, silver));
