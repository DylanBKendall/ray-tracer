...
void buildScene() {
	IShapePtr sphere1 = new ISphere(dvec3(0, 3, 0), 6.0);
	IShapePtr cylinder1 = new ICylinderY(dvec3(0, 3, 0), 2.0, 7.0);
...
void render() {
	...
	dvec3 cameraPos = dvec3(R * std::cos(-rads), 20, R * std::sin(-rads));
