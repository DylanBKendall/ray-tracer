...
static void render() {
    ...
    //viewingMatrix = glm::lookAt(dvec3(0, 5, 0), dvec3(0, 0, 0), Y_AXIS);
	
	viewingMatrix =
		glm::lookAt(dvec3(-4, 4, 4), dvec3(0, 0, 0), dvec3(0, 1, 0));

	//viewingMatrix = glm::translate(dvec3(0.0, 0.0, -12.0));

    /*glm::dmat4 R1 = glm::rotate(glm::radians(90.0), glm::dvec3(0.0, 1.0, 0.0));
    glm::dmat4 R2 = glm::rotate(glm::radians(90.0), glm::dvec3(1.0, 0.0, 0.0));*/
	...
	//projectionMatrix = glm::ortho(-18.0, 18.0, -16.0, 16.0, 1.0, 100.0);
...
void keyboard(unsigned char key, int x, int y) {
    ...
    case 'W':
    case 'w':
        VertexOps::polygonRenderMode = (VertexOps::polygonRenderMode == FILL) ? LINE : FILL;
        break;
